...
<div class="board-container">
    ...
    <form action="<?= get_url("/newpost?board={$board_uri}"); ?>" method="POST" class="new-post-form">

        <textarea name="post-text" id="post-text" cols="30" rows="10" class="text"></textarea>
        <input type="file" name="board_text" id="board-text">
        ...
        <?php for ($i = 0; $i < 10; ++$i) : ?>
            <li class="post">
                ...
                <div class="post-info">
                    ...
                    <h3 class="post-owner">&#x27A4; <a href="#">38712782378</a></h3> <!-- .post-owner -->
